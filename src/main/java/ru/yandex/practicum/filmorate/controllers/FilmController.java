...
import ru.yandex.practicum.filmorate.exceptions.NoFilmByIdException;
...
public class FilmController {
    ...
    public Collection<Film> getPopular(@RequestParam(value = "count", defaultValue = "10") final int count) {
